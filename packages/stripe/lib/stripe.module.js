...
let StripeModule = StripeModule_1 = class StripeModule extends (0, nestjs_modules_1.createConfigurableDynamicRootModule)(stripe_constants_1.STRIPE_MODULE_CONFIG_TOKEN, {
    ...
    providers: [
        ...
        },
        {
            ...
            useFactory: (_a) => {
                var { apiKey, typescript = true, apiVersion = '2022-08-01', webhookConfig } = _a, options = __rest(_a, ["apiKey", "typescript", "apiVersion", "webhookConfig"]);
    ...
    async onModuleInit() {
        ...
        const noOneSecretProvided = this.stripeModuleConfig.webhookConfig &&
            ...
            !((_b = this.stripeModuleConfig.webhookConfig) === null || _b === void 0 ? void 0 : _b.stripeSecrets.connect);
